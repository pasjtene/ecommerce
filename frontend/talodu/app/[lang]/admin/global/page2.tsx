...
export default function GlobalSettings() {
  ...
  // Site Images Functions (same as before)
  ...
  // Site Logos Functions (same as before)
        ...
        <div className="card shadow-sm mb-4">
          ...
          <div className="card-body">
            <form onSubmit={handleSubmit}>
              ...
              {activeTab === 'general' && (
                <div>
                  <h5 className="mb-4">General Site Configuration</h5>
                  <div className="row">
              ...
              {activeTab === 'carousel' && (
                <div>
                  <h5 className="mb-4">Carousel Configuration</h5>
                    ...
                    <div className="col-md-6 mb-3">
                      <div className="form-check form-switch">
                        <input
                          ...
                          checked={settings.displaySettings.carouselAutoPlay}
                          onChange={handleDisplaySettingChange}
                          className="form-check-input"
                          disabled={loading || !settings.displaySettings.showCarousel}
                        />
                        <label htmlFor="carouselAutoPlay" className="form-check-label">
                          Auto Play
                        </label>
                      </div>
                      <small className="form-text text-muted">
                    ...
                    <div className="col-md-6 mb-3">
                      <div className="form-check form-switch">
                        <input
                          ...
                          name="carouselShowIndicators"
                          checked={settings.displaySettings.carouselShowIndicators}
                          onChange={handleDisplaySettingChange}
                          className="form-check-input"
                          disabled={loading || !settings.displaySettings.showCarousel}
                        />
                        <label htmlFor="carouselShowIndicators" className="form-check-label">
                          Show Indicators
                        </label>
                      </div>
                      <small className="form-text text-muted">
                    ...
                    <div className="col-md-6 mb-3">
                      <div className="form-check form-switch">
                        <input
                          ...
                          name="carouselShowControls"
                          checked={settings.displaySettings.carouselShowControls}
                          onChange={handleDisplaySettingChange}
                          className="form-check-input"
                          disabled={loading || !settings.displaySettings.showCarousel}
                        />
                        <label htmlFor="carouselShowControls" className="form-check-label">
                          Show Controls
                        </label>
                      </div>
                      <small className="form-text text-muted">
                  ...
                  <div className="row">
                    <div className="col-md-6 mb-3">
                      <label htmlFor="carouselInterval" className="form-label">
                      ...
                      <input
                        ...
                        value={settings.displaySettings.carouselInterval}
                        onChange={handleDisplaySettingChange}
                        className="form-control"
                        min="1000"
                        max="30000"
                        step="1000"
                        disabled={loading || !settings.displaySettings.showCarousel || !settings.displaySettings.carouselAutoPlay}
                      />
                      <small className="form-text text-muted">
                        Time between automatic transitions (1000-30000 milliseconds)
                      </small>
                    </div>

                    <div className="col-md-6 mb-3">
                      <label htmlFor="carouselTransitionDuration" className="form-label">
                        Transition Duration (ms)
                      </label>
                      <input
                        type="number"
                        id="carouselTransitionDuration"
                        name="carouselTransitionDuration"
                        value={settings.displaySettings.carouselTransitionDuration}
                        onChange={handleDisplaySettingChange}
                        className="form-control"
                        min="100"
                        max="2000"
                      ...
                      />
                      <small className="form-text text-muted">
                        Duration of transition animations (100-2000 milliseconds)
                      </small>
                    </div>
                  </div>
                  ...
                  <div className="row">
                    <div className="col-md-6 mb-3">
                      <label htmlFor="carouselTransitionType" className="form-label">
                        Transition Type
                      </label>
                      <select
                        id="carouselTransitionType"
                        name="carouselTransitionType"
                        value={settings.displaySettings.carouselTransitionType}
                        onChange={handleDisplaySettingChange}
                        className="form-select"
                        disabled={loading || !settings.displaySettings.showCarousel}
                      >
                      ...
                      <small className="form-text text-muted">
                        Animation style for transitions between images
                      </small>
                    </div>
                  </div>
                </div>
              ...
              {activeTab === 'display' && (
                <div>
                  <h5 className="mb-4">Page Display Settings</h5>
                  <div className="row">
                    <div className="col-md-6 mb-3">
                      <div className="form-check form-switch">
                        <input
              ...
              {activeTab === 'images' && (
                <div>
                  <h5 className="mb-4">Site Carousel Images</h5>
              ...
              {activeTab === 'logos' && (
                <div>
                  <h5 className="mb-4">Site Logos</h5>
              ...
              {/* Save Button */}
              <div className="d-flex gap-2 justify-content-end pt-4 border-top mt-4">
                <button
                  type="button"
                  className="btn btn-outline-secondary"
