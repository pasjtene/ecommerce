			...
			<SubHeader>
				<SubHeaderLeft>
					...
					<CommonAvatarTeam isAlignmentEnd>
						<strong>Sports</strong> Team hi {user?.FirstName} {user?.LastName}
					</CommonAvatarTeam>
				</SubHeaderLeft>
				<SubHeaderRight>
					<span className='text-muted fst-italic me-2'>Last update:</span>
					<span className='fw-bold'>11 hours ago</span>
				</SubHeaderRight>
			</SubHeader>
			<Page>
				<div className='pt-3 pb-5 d-flex align-items-center'>
					<span className='display-5 fw-bold me-3'>{`${data.name} ${data.surname}`}</span>
