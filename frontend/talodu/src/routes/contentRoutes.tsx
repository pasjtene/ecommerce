...
const APP = {
	...
	SALES: {
		...
		SHOP_CREATE: lazy(() => import('../pages/presentation/sales/ShopCreate')),
		SHOP_PRODUCTS: lazy(() => import('../pages/presentation/sales/ShopProductList')),
...
const presentation: RouteProps[] = [
	...
	{
		path: `${demoPagesMenu.sales.subMenu.shopProducts.path}/:id`,
		element: <APP.SALES.SHOP_PRODUCTS />,
	},
	{
	...
	{
		path: `${demoPagesMenu.sales.subMenu.shopCreate.path}`,
		element: <APP.SALES.SHOP_CREATE/>,
	},
	...
	},
	{
		...
		element: <ProtectedRoute allowedRoles={['Admin', 'SuperAdmin']}> <APP.APPOINTMENT.EMPLOYEE_LIST /> </ProtectedRoute>,
	},
	{
		path: `${demoPagesMenu.appointment.subMenu.employeeID.path}/:id`,
		element: <ProtectedRoute allowedRoles={['Admin', 'SuperAdmin']}><APP.APPOINTMENT.EMPLOYEE_VIEW /></ProtectedRoute>,
	},
	{
	...
	{
		path: `${demoPagesMenu.crm.subMenu.userID.path}/:id`,
		element: <APP.CRM.USER />,
	},
