...
### Code Navigation:
All text for the Aside menu are located in: src/menu.ts
-> The CustomerList.ts is located in facit/src/pages/presentation/crm/CustomerList.tsx
-> routes to access that content is defined in src/routes/contentRoutes.tsx
-> other content pages can be found via the same path

-> heagers are located at: src/pages/_layout/_headers/
->The Profilepageheader (with user image left), is located at: src/pages/_layout/_headers/ProfilePageHeader.tsx
